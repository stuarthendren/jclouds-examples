 ...
 *
 * <p>
 * It defaults to zone europe-west1-b, image debian-7-wheezy and profile f1-micro and can be
 * configured with system properties, <code>zone</code>, <code>image</code> and <code>profile</code>.
 *
 * @see Constants
 */
public class CreateServer implements Closeable {
	 ...
	 * href="http://jclouds.apache.org/guides/google/">http://jclouds.apache.org/guides/google/</a>
	 *
	 * <p>
	 * The first argument (args[0]) is your service account email address
	 * (https://developers.google.com/console/help/new/#serviceaccounts). The second argument
	 * (args[1]) is a path to your service account private key PEM file without a password. It is
	 * used for server-to-server interactions
	 * (https://developers.google.com/console/help/new/#serviceaccounts). The key is not transmitted
	 * anywhere.
	 *
	 * <p>
	 * Example:
	 ...
	 * {@link TemplateBuilder#fromImage(Image)} to also demonstrate iterating through Hardware and
	 * Images.
	 *
	 * <p>
	 * Alternatively you do the same without iterating, specifiying the required details, for
	 * example:
	 *
	 * <pre>
	...
	/**
	 * This method uses the generic ComputeService.listHardwareProfiles() to find the hardware
	 * profile.
	 *
	 * @return The Hardware for {@link Constants#ZONE} and {@link Constants#PROFILE}.
	 */
